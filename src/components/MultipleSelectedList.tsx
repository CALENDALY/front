...
type L1Keys = { key?: any; value?: any; image?: any; disabled?: boolean | undefined }
                                        ...
                                        if(disabled){
                                            ...
                                            return(
                                                <TouchableOpacity style={[styles.option,dropdownItemStyles]} key={index} onPress={ () => {
                                                    ...
                                                    <Image source={{uri:item.image}} style={{width:30,height:30,paddingLeft:7, borderRadius:50}}></Image>
